...
export default function ComfortLearn() {
  return (
    <div className="absolute h-[50.833vw] left-[6.458vw] top-[288.333vw] w-[93.490vw]" data-name="comfort-learn" data-node-id="3049:41">
        ...
        <p className="absolute font-russo h-[8.490vw] leading-[89.95500183105469%] left-[72.552vw] not-italic text-[3.333vw] text-black text-center top-[11.510vw] tracking-[-0.067vw] translate-x-[-50%] w-[37.292vw] whitespace-pre-wrap" data-node-id="3049:44">
        ...
        <div className="absolute h-[28.594vw] left-0 top-[21.979vw] w-[45.990vw]" data-name="left-column" data-node-id="3049:45">
          <div className="absolute flex flex-col font-arsenal h-[22.240vw] justify-center leading-[0] left-[1.406vw] not-italic text-[0vw] text-black top-[17.161vw] translate-y-[-50%] w-[44.583vw]" data-node-id="3049:46">
            <p className="leading-[normal] mb-0 text-[1.667vw] whitespace-pre-wrap">
              <span className="font-arsenal font-bold">Продолжительность:</span>
              <span className="font-arsenal">{` Февраль — Декабрь `}</span>
            </p>
            <p className="leading-[normal] mb-0 text-[1.667vw] whitespace-pre-wrap">&nbsp;</p>
            <p className="leading-[normal] mb-0 text-[1.667vw] whitespace-pre-wrap">
              <span className="font-arsenal font-bold not-italic text-black">Практика:</span>
              <span>{` Включает июльскую археологическую практику `}</span>
            </p>
            <p className="leading-[normal] mb-0 text-[1.667vw] whitespace-pre-wrap">&nbsp;</p>
            <p className="leading-[normal] mb-0 text-[1.667vw] whitespace-pre-wrap">
              <span className="font-arsenal font-bold not-italic text-black">Формат:</span>
              <span>{` Очно-заочный (дистанционные технологии + очная практика) `}</span>
            </p>
            <p className="leading-[normal] mb-0 text-[1.667vw] whitespace-pre-wrap">&nbsp;</p>
            <p className="leading-[normal] mb-0 text-[1.667vw] whitespace-pre-wrap">
              <span className="font-arsenal font-bold not-italic text-black">{`Ваш результат `}</span>
              <span>{`(на выбор): `}</span>
            </p>
          ...
          <div className="absolute flex flex-col font-russo h-[3.958vw] justify-center leading-[0] left-0 not-italic text-[2.500vw] text-black top-[1.979vw] translate-y-[-50%] w-[34.896vw]" data-node-id="3049:47">
        ...
        <div className="absolute h-[4.583vw] left-[48.021vw] top-[37.865vw] w-[37.500vw]" data-name="paragraph-3" data-node-id="3049:52">
          <p className="absolute font-arsenal h-[4.583vw] leading-[normal] left-[3.594vw] not-italic text-[0vw] text-[1.667vw] text-black top-0 w-[33.906vw] whitespace-pre-wrap" data-node-id="3049:53">
            <span className="font-arsenal font-bold">Онлайн:</span>
        ...
        <div className="absolute h-[3.125vw] left-[48.021vw] top-[27.656vw] w-[38.125vw]" data-name="paragraph-1" data-node-id="3049:58">
          <p className="absolute font-arsenal h-[2.396vw] leading-[normal] left-[4.271vw] not-italic text-[0vw] text-[1.667vw] text-black top-0 w-[33.854vw] whitespace-pre-wrap" data-node-id="3049:59">
            <span className="font-arsenal font-bold">Когда:</span>
            <span>{` С 20 сентября, по средам, 19:00`}</span>
          </p>
