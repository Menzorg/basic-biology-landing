...
import imgBackground from '../assets/desktop/imgBackground.png';
import imgBackgroundImage from '../assets/desktop/imgBackgroundImage.png';
import imgNavigation from '../assets/desktop/imgNavigation.svg';
  ...
  return (
    <div className="absolute h-[58.802vw] left-0 top-[345.625vw] w-[99.948vw]" data-name="course-program-block" data-node-id="3049:27">
        <div className="absolute h-[30.677vw] left-0 top-0 w-[99.948vw]" data-name="background" data-node-id="3049:28">
          <Image fill alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgBackground} />
        </div>
        <div 
        ...
        >
          ...
          <div className="absolute h-0 left-[2.969vw] top-[25.104vw] w-[80.938vw]" data-name="navigation" data-node-id="3049:37">
            <div className="absolute inset-[-2.109vw_-0.35%]">
              <Image fill alt="" className="block max-w-none size-full" src={imgNavigation} />
              {/* Prev Button */}
              <div 
