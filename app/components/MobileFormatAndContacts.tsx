        ...
        <div className="absolute flex flex-col font-arsenal h-[50.933vw] justify-center leading-[0] left-[6.933vw] not-italic text-[3.733vw] text-black top-[186.800vw] translate-y-[-50%] w-[85.867vw] whitespace-pre-wrap" data-node-id="3049:163">
          ...
          <ul className="list-disc mb-0">
            <li className="leading-[normal] mb-0 ms-[5.600vw]">
              <span className="font-arsenal font-bold not-italic">Телефон:</span>
              <span>{` [Ваш номер телефона] `}</span>
            </li>
            <li className="leading-[normal] mb-0 ms-[5.600vw]">
              <span className="font-arsenal font-bold not-italic">Telegram:</span>
              <span>{` [Ваша ссылка на Telegram] `}</span>
            </li>
            <li className="leading-[normal] ms-[5.600vw]">
              <span className="font-arsenal font-bold not-italic">ВКонтакте:</span>
